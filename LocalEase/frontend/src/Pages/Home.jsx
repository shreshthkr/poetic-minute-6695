...
const Home = () => {
  ...
  const headerImages = [
    {
      id: "8",
      url: "https://img4.nbstatic.in/tr:w-/636ce2bc22156b000b884c73.png",
      text: "Night Deals",
    },
  ...
  const cards = [
    ...
    "https://img4.nbstatic.in/tr:w-2800/64213cdf8db992000bb661fb.jpg",
  ...
  const images = [
    ...
    "https://img4.nbstatic.in/tr:w-350/61fbad386f487a000bf5658d.jpeg",
    "https://img4.nbstatic.in/tr:w-350/6130d7931e2731000b3c2663.jpg",
    "https://img4.nbstatic.in/tr:w-350/61fbad386f487a000bf5658d.jpeg",
  ];
  ...
  return (
    <Container maxW="100%" mt="82px">
      {/* Header */}

      <Container maxH="120px" maxWidth="100%" margin="auto" shadow="base">
        <Container
          height={"110px"}
          maxWidth="90%"
          margin="auto"
          paddingLeft={"120px"}
        >
          <SimpleGrid columns={[5, 6, 7, 8, 9]} spacing={2}>
            {headerImages.map((el) => (
              <Card
                key={el.id}
                textAlign="center"
      ...
      <Container maxW="90%" margin={"auto"} marginTop="50px">
        <Text fontWeight="900" textAlign="left" fontSize="2xl">
          Everything Buffet
        </Text>
      </Container>
      ...
      <Container maxW="90%" margin="auto" marginTop="20px">
        <SimpleGrid columns={[1, 2, 3]} spacing={5}>
          {newdata
            ?.filter((el) => el.name == "Swiggy Money")
            .map((el) => (
              <Card
                key={el.id}
                p="30px"
              ...
              >
                ...
                <Divider mt="10px" />
                <Text fontSize={"12px"} textAlign="left" margin={"5px"}>
                  {el.desc}
                </Text>
              </Card>
            ))}
      ...
      <Container maxW="90%" marginTop="10px" maxH="200px">
        <ImageSlider
          data={newdata?.filter((el) => el.typeFilter === "Restaurant Deals")}
        />
      </Container>
      ...
      <Container maxW="90%" margin="auto" marginTop="10px">
        <SimpleGrid columns={[1, 2, 3, 4, 5]} spacing={5}>
          {images.map((img, index) => (
            <Card key={index} _hover={{ boxShadow: "5px 5px 20px grey" }}>
              <Image
                src={img}
                maxW="250px"
                maxH={"300px"}
      ...
      <Container maxW="90%" margin="auto" marginTop="10px">
        <SimpleGrid columns={[1, 2, 3, 4]} spacing={5}>
          {newdata
            ?.filter((el) => el.typeFilter == "Salon Deals")
            .map((el) => (
              <Card
                key={el.id}
                maxH={"400px"}
              ...
              >
                <Image
                  ...
                  borderRadius="5px"
                />
                <Text fontSize={"12px"} textAlign="left" margin={"20px"}>
                  {el.desc}
                </Text>
              </Card>
            ))}
      ...
      <Container maxW="90%" margin="auto" marginTop="10px">
        <SimpleGrid columns={[1, 2, 3, 4, 5]} spacing={5}>
          {newdata
            ?.filter((el) => el.typeFilter == "Health")
            .map((el) => (
              <Card
                key={el.id}
                maxH={"400px"}
              ...
              >
                <Image
                  ...
                  borderRadius="5px"
                />
                <Text fontSize={"15px"} textAlign="left" margin={"20px"}>
                  {el.desc}
                </Text>
              </Card>
            ))}
