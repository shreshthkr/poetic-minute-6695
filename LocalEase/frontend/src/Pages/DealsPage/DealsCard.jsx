      ...
      <div className={styles.menu_div}>
        <div className={styles.menu_div2}>
          ...
          <div className={styles.menu_list_div4}>
            <p>
              Valid for : <span>{deal.Valid_for}</span> | Valid on :{" "}
              <span>{deal.Valid_on}</span> | Timings :{" "}
          ...
          <div className={styles.menu_list_div5}>
            ...
            <div className={styles.addtocart}>
              {count === 0 ? (
                <button onClick={() => handleAddToCart(deal)}>Add +</button>
              ) : (
                <div className={styles.addedtocart}>
                  <button className={styles.substract} onClick={handleDecrease}>
                    -
                  </button>
                  <div className={styles.count}>{count}</div>
                  <button className={styles.add} onClick={handleIncrease}>
                    +
                  </button>
                </div>
              )}
